...
public class NoticeController {
		...
		public String need_login(HttpSession session) {
			session.invalidate();
			String request_mapping = "<script>alert('로그인 해야 합니다.');"+ "location.href='/dogfoot/notice_list.do'</script>";
		...
		public String invaid_update(HttpSession session) {
			String request_mapping = "<script>alert('비정상적인 접근입니다.');"+ "location.href='/dogfoot/notice_list.do'</script>";
