...
<body>
	...
	<div id="find_id">
	<h3>아이디 찾기</h3>
		<form action="${pageContext.request.contextPath}/find_id_process.do" method="post" id="find_id_form">
		...
		<button href="${pageContext.request.contextPath}/id_check.do" id="find_id_button" onclick="find_id(); return false;">아이디 찾기</button>
		<button id="return" onclick=location.href="${pageContext.request.contextPath}/join.do">회원가입</button>
	</div>
	<div id="find_pw">
	<h3>비밀번호 찾기</h3>
		<form action="${pageContext.request.contextPath}/find_pw_process.do" method="post" id="find_pw_form">
			<input type="text" id="member_id" name="member_id" placeholder="아이디"  maxlength="20" required />
			<input type="text" id="member_quest" name="member_quest"  maxlength="40" readonly required />
			<input type="text" id="member_answer" name="member_answer" placeholder="정답입력"  maxlength="10" required />
			<br>
		</form>
		<button href="${pageContext.request.contextPath}/id_check.do" id="find_pw_button1" onclick="find_pw(); return false;">비밀번호 찾기</button>
