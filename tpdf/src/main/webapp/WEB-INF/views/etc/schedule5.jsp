...
$(document).ready(function () {
	 $.ajax({
	    url:"${pageContext.request.contextPath}/schedule_data5.do",
	    type : "get",
	    dataType: "json",
  ...
  <main>
  	...
  	<br>
  		<div class="schedule_month">
   			<ul class="list">
   				<li>
	   				<a  style="cursor:pointer" class="SA_one">
						<span class="year">2022년</span>
						<span class="month">8월</span>
					</a>
   				</li>
   				<li>
	   				<a style="cursor:pointer" class="SA_two" >
						<span class="year">2022년</span>
						<span class="month">9월</span>
					</a>
   				</li>
   				<li>
	   				<a style="cursor:pointer" class="SA_three">
						<span class="year">2022년</span>
						<span class="month">10월</span>
					</a>
   				</li>
   				<li>
	   				<a style="cursor:pointer" class="SA_four" >
						<span class="year">2022년</span>
						<span class="month">11월</span>
					</a>
   				</li>
	   				<li><a style="cursor:pointer" class="SA_five" >
						<span class="year">2022년</span>
