...
$(document).ready(function () {
	 $.ajax({
	    url:"${pageContext.request.contextPath}/schedule_data3.do",
	    type : "get",
	    dataType: "json",
...
#league_menu a {
  ...
  #league_menu_c {font-weight:bold;}
  ...
  <main>
  	...
  	<br>
  		<div class="schedule_month">
   			<ul class="list">
   				<li>
   				<a style="cursor:pointer" class="PD_one">
					<span class="year">2022년</span>
										<span class="month">8월</span>
				</a>
   				</li>
   				<li>
   				<a style="cursor:pointer" class="PD_two">
					<span class="year">2022년</span>
										<span class="month">9월</span>
				</a>
   				</li>
   				<li>
   				<a style="cursor:pointer" class="PD_three">
					<span class="year">2022년</span>
										<span class="month">10월</span>
				</a>
   				</li>
   				<li>
   				<a style="cursor:pointer" class="PD_four">
					<span class="year">2022년</span>
										<span class="month">11월</span>
				</a>
   				</li>
   				<li><a style="cursor:pointer" class="PD_five">
					<span class="year">2022년</span>
