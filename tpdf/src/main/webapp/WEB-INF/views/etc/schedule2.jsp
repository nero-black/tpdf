...
$(document).ready(function () {
	 $.ajax({
	    url:"${pageContext.request.contextPath}/schedule_data2.do",
	    type : "get",
	    dataType: "json",
...
#league_menu a {
  ...
  #league_menu_b {font-weight:bold;}
  ...
  <main>
  	...
  	<br>
  		<div class="schedule_month">
   			<ul class="list">
   				<li>
   				<a style="cursor:pointer" class="CL_one">
					<span class="year">2022년</span>
										<span class="month">8월</span>
				</a>
   				</li>
   				<li>
   				<a style="cursor:pointer" class="CL_two">
					<span class="year">2022년</span>
										<span class="month">9월</span>
				</a>
   				</li>
   				<li>
   				<a style="cursor:pointer" class="CL_three">
					<span class="year">2022년</span>
										<span class="month">10월</span>
				</a>
   				</li>
   				<li>
   				<a style="cursor:pointer" class="CL_four">
					<span class="year">2022년</span>
										<span class="month">11월</span>
				</a>
   				</li>
   				<li><a style="cursor:pointer" class="CL_five">
					<span class="year">2022년</span>
