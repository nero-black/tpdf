...
<%
				...
				JSONObject jsonObject1 = (JSONObject)jsonParser.parse(line);
				...
				//오브젝트 배열
				JSONObject filtersObject1 = (JSONObject)jsonObject1.get("filters");
				JSONObject areaObject1 = (JSONObject)jsonObject1.get("area");
				JSONObject competitionObject1 = (JSONObject)jsonObject1.get("competition");
				JSONObject seasonObject1 = (JSONObject)jsonObject1.get("season");
				
	
				
				//스탠딩 배열
				JSONArray standingsArray = (JSONArray)jsonObject1.get("standings");
