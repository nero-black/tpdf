...
<main>
	...
	<input type="text" id="team_a" name="team_a" placeholder="첫 번째 항목" required maxlength="15" /><br>
	<input type="text" id="team_b" name="team_b" placeholder="두 번째 항목" required maxlength="15" />
	</form>
	<br><br>
