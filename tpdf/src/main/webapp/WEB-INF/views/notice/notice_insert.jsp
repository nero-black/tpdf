...
<script src="${pageContext.request.contextPath}/resources/js/notice_insert.js"></script>
<body>
<main>

<form action="${pageContext.request.contextPath}/notice_insert_process.do" method="post" enctype="form-data">
